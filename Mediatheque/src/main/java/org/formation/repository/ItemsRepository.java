...
public interface ItemsRepository extends JpaRepository<Items, Long> {
	...
	@Query("FROM Items WHERE (date_parution - CURRENT_DATE) BETWEEN 0 AND 14 ")
	 ...
	 * 
	 * @Query("FROM Dvd") List<Items> findAllDvd();
	 * 
	 * @Query("FROM Cd") List<Items> findAllCd();
	 * 
	 * @Query("FROM Livre") List<Items> findAllLivre();
	 */
